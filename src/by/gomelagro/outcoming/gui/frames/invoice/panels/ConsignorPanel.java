...
public class ConsignorPanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public ConsignorPanel(SenderItem item) {
		...
		JLabel consignorLabel = new JLabel("Реквизиты грузоотправителя [consignor] ");
		...
		JLabel countryCodeTagLabel = new JLabel("Код страны Грузоотправителя");
